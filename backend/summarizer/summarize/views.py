...
def handle_uploaded_file(title,f,ext):
	...
	filepath = f'D:\Projects\summarizer\\backend\summarizer\\files\{title}.{ext}'
	...
	flac_file = 'D:\Projects\summarizer\\backend\summarizer\\files\{}.flac'.format(title)
	...
	credentials = r"D:\\Projects\\rising-cable-348608-a1a7404667d8.json"
	# credentials = r"/home/ubuntu/minor-proj/rising-cable-348608-a1a7404667d8.json"
...
def upload_file(request):
	if request.method == 'POST':
		...
		if form.is_valid():
			...
			# print(output)
			return Response({"text": output}, status = status.HTTP_200_OK)
	return Response({"text": "summarizing failed"}, status = status.HTTP_500_INTERNAL_SERVER_ERROR)